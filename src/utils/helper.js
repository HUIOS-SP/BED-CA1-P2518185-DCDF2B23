...
// Converts a value to a positive integer and returns null when invalid
export function checkAndGetPositiveInteger(value) {
  // Reject booleans, arrays, objects, null, and blanks before Number() gets creative
...
// Returns a fallback only for missing values; valid zero/false values keep their dignity
